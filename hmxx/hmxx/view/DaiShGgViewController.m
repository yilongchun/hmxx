...
@interface DaiShGgViewController ()<MBProgressHUDDelegate,SRRefreshDelegate>{
    MBProgressHUD *HUD;
...
@implementation DaiShGgViewController
...
- (void)loadData{
    ...
    MKNetworkOperation *op = [engine operationWithPath:@"/schoolNotice/findPageList.do" params:dic httpMethod:@"GET"];
...
//        NSNumber *noticecount = [info objectForKey:@"nocount"];
        NSString *creatorName = [info objectForKey:@"creatorName"];
        ...
        cell.gpinglun.text = creatorName;
        [cell.gpinglun setTextAlignment:NSTextAlignmentLeft];
        cell.gdate.text = tncreatedate;
        cell.gsource.text = [NSString stringWithFormat:@"%@",noticename];
...
//    }else{
    if (indexPath.row < [self.dataSource count]) {
        ...
        NSString *creatorName = [info objectForKey:@"creatorName"];
        DaishGgtzViewController *ggxq = [[DaishGgtzViewController alloc]init];
        ggxq.title = @"公告详情";
        ggxq.tnid = tnid;
        ggxq.creater = creatorName;
